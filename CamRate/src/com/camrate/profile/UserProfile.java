...
public class UserProfile extends Activity {
	...
	public void init() {
		...
		Constant.arrActivity.add(UserProfile.this);
		initProcessDialog();
		...
		chknet = new checkInternet(UserProfile.this);
	...
	public void SimpleAlert(String t, String b, final int position) {
		Builder builder = new AlertDialog.Builder(UserProfile.this);
		builder.setTitle(t);
		...
		builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
				Intent intent = new Intent(UserProfile.this, GeneralUserProfile.class);
