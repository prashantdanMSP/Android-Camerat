...
public class TabGroupActivity extends ActivityGroup {
	...
	/**
	 * This is called when a child activity of this one calls its finish method. This implementation calls {@link LocalActivityManager#destroyActivity} on the child activity and starts the previous
	 * activity. If the last child activity just called finish(),this activity (the parent), calls finish to finish the entire group.
	 */
	@Override
