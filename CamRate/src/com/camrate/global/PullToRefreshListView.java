...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		mRefreshViewText.setTypeface(SplashScreen.ProxiNova_Regular);
	...
	private void resetHeader() {
		if (mRefreshState != TAP_TO_REFRESH) {
			...
			mRefreshViewImage.setImageResource(R.drawable.pullrefresh);
	...
	/**
	 * Invoked when the refresh view is clicked on. This is mainly used when there's only a few items in the list and it's not possible to drag the list.
	 */
