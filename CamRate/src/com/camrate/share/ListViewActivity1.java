...
public class ListViewActivity1 extends Activity {
	...
	public void init() {
		context = ListViewActivity1.this;
		...
		prefs = PreferenceManager.getDefaultSharedPreferences(ListViewActivity1.this);
		...
		textView_addManually.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(ListViewActivity1.this, ManuallyAdd.class);
		...
		textView_fromContacts.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ListViewActivity1.this, ContactsList.class);
		...
		btnDone.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (array.length() > 0) {
					...
					intent.putExtra("emaillist", array + "");
					setResult(1, intent);
					finish();
	...
	private class SendEmailList extends android.os.AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result.equalsIgnoreCase("1")) {
				Toast.makeText(ListViewActivity1.this, "Email send successfully", Toast.LENGTH_LONG).show();
			}
			finish();
		}
	};
